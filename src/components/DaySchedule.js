        ...
        if(isFullDaySchedule) {
            ...
            return (
                <div>
                  ...
                  {
                    !showEditMember && 
                    <button style={{ "borderWidth": "thin", background: "yellow"}} onClick={(e) => this.changeSupport(e)}>{
                      _.find(this.props.members, member => member.id == fullDaySchedule.member.id) ? _.find(this.props.members, member => member.id == fullDaySchedule.member.id).name : "Unassigned"}
                      </button> 
                  }
              </div>
            )
